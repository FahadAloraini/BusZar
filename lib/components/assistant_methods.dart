...
import 'package:testing_phase1/components/trips_history_model.dart';
import 'global.dart';
...
class AssistantMethods {
  static Future<String> searchAddressForGeographicCoOrdinates(
    ...
    String apiUrl =
        "https://maps.googleapis.com/maps/api/geocode/json?latlng=${position.latitude},${position.longitude}&key=AIzaSyBrmrhO6Okkfo1noD68vaFC3TEUuu-UeY0";
  ...
  static void readCurrentOnlineUserInfo() async {
    ...
    userRef.once().then((snap) {
      if (snap.snapshot.value != null) {
        ...
        print("hello from the usermodelinfo");
        print(userModelCurrentInfo!.email.toString());
        print(userModelCurrentInfo!.phone.toString());
        print(userModelCurrentInfo!.name.toString());
      }
    });
  }
  ...
  static Future<DirectionDetailsInfo?>
    ...
    String urlOriginToDestinationDirectionDetails =
        "https://maps.googleapis.com/maps/api/directions/json?origin=${origionPosition.latitude},${origionPosition.longitude}&destination=${destinationPosition.latitude},${destinationPosition.longitude}&key=AIzaSyBrmrhO6Okkfo1noD68vaFC3TEUuu-UeY0";
  ...
  static void readTripsHistoryInformation(context) {
    ...
    for (String eachKey in tripsAllKeys) {
      FirebaseDatabase.instance
        ...
        if ((snap.snapshot.value as Map)["status"] == "paid") {
