...
class TripsTicketUIWidget extends StatefulWidget {
  TripsHistoryModel? tripsHistoryModel;

  TripsTicketUIWidget({this.tripsHistoryModel});

  @override
  State<TripsTicketUIWidget> createState() => _TripsTicketUIWidgetState();
}

class _TripsTicketUIWidgetState extends State<TripsTicketUIWidget> {
