...
class ComplaintReportUI extends StatefulWidget {
  String? TripID;

  ComplaintReportUI({this.TripID});
  @override
  State<ComplaintReportUI> createState() => _ComplaintReportUIState();
}

class _ComplaintReportUIState extends State<ComplaintReportUI> {
  @override
  String ReportText = "";
            ...
            Padding(
              ...
              child: TextField(
                decoration: InputDecoration(
                  ...
                  hintText: AppLocalizations.of(context)!.tellusabouttheproblem,
